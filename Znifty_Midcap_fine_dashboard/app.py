...
class MidcapAnalyzer:
    """Business logic for analyzing Nifty Midcap 50 stock data"""
    
    def __init__(self):
        print("[DEBUG] Initializing MidcapAnalyzer")
        self.api_url = "https://www.nseindia.com/api/option-chain-v3?type=Indices&symbol=MIDCPNIFTY"
        self.headers = {
            'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36',
            'Accept': 'application/json',
            'Accept-Language': 'en-US,en;q=0.9',
        }
        print("[DEBUG] MidcapAnalyzer ready")
    ...
    def analyze(self):
        ...
        # Filter valid stocks and exclude MIDCPNIFTY index itself
