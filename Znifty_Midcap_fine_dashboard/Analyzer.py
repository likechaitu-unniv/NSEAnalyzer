"""
Nifty Midcap Market Trend Analyzer
...
from utils import calculate_oi_pcr, derive_and_classify_midcap_option_chain, derive_pcr, fetch_midcap_option_chain, write_to_local
...
class MidcapTrendAnalyzer:
    """Analyzes Nifty Midcap options chain data to predict market trend"""
    ...
    def generate_composite_signal(self) -> Dict:
        ...
        options, spot  = derive_and_classify_midcap_option_chain(self.data)
...
def main():
    ...
    data = fetch_midcap_option_chain("30-Dec-2025")
